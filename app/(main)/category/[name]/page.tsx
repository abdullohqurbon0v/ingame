...
const brangs = ["GIGABYTE Aorus", "ALIENWARE AURORA", "Lenovo Legion T7", "Acer Predator Orion", "ARENA 9604", "GAMER PRO RYZEN"]
                              ...
                              <div className='flex justify-center space-x-2 mt-10'>
                                    ...
                                    {[...Array(totalPages)].map((_, idx) => (
                                          <Button
                                                ...
                                                className={`px-4 py-2 ${currentPage === idx + 1 ? 'bg-pink-500' : 'bg-gray-700'}`}>
                                                {idx + 1}
                                          </Button>
                                    ))}

...
const CartItem = ({ item }) => {
      return (
            <div className="flex items-center justify-between bg-gray-900 p-4 rounded-lg mb-4">
                  ...
                  <p className="text-white">{item.price} сум/мес</p>
...
const CartPage = () => {
      const cartItems = [
            { image: 'https://via.placeholder.com/60', title: 'Название товара', details: 'Доп. данные', availability: 'Заказ 4-7 дней', quantity: 1, price: '2 343 444' },
            { image: 'https://via.placeholder.com/60', title: 'Название товара', details: 'Доп. данные', availability: 'Заказ 4-7 дней', quantity: 1, price: '2 343 444' },
            { image: 'https://via.placeholder.com/60', title: 'Название товара', details: 'Доп. данные', availability: 'Заказ 4-7 дней', quantity: 1, price: '2 343 444' },
      ];
            ...
            <div className='max-w-[1200px] mx-auto mt-16'>
                  <div className="bg-black min-h-screen p-10 text-white">
                        ...
                        <div className="flex justify-between items-center mt-6 p-4 bg-gray-800 rounded-lg">
                              <input type="text" placeholder="Промокод" className="p-2 bg-gray-700 rounded text-white w-1/3" />
                        ...
                        <div className="mt-6 p-4 bg-gray-800 rounded-lg flex justify-between items-center">
                              ...
                              <button className="bg-pink-500 px-6 py-2 rounded text-white font-bold">Продолжить</button>
                        </div>
                  </div>
            </div>
      );
